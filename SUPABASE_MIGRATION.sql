...
-- ============================================
-- Что было сделано:
-- ✅ Добавлен voice_id в chat_sessions (5 голосов)
-- ✅ Обновлены тарифы в profiles (free, basic, plus, pro)
-- ✅ Создана таблица billing_subscriptions (для YooKassa)
-- ✅ Настроены RLS политики безопасности
-- ✅ Создан триггер для updated_at
-- ============================================
